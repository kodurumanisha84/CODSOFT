...
def play():
    ...
    # Combining everything in one message
    message = (
...
# Play Button
generate_btn = tk.Button(window, text="Play Round", command=play, bg="green", fg="black", font=("Times New Roman", 12))
...
# Continue Button
continue_btn = tk.Button(window, text="End Game", command=check_continue, bg="pink", fg="black", font=("Times New Roman", 12))
